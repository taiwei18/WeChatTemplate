...
axiosInstance.interceptors.response.use(
    (res) => {
        ...
        const customCode = (serve.code >= 90000 && serve.code <= 99999);
        ...
        } else if (serve.code !== 200 && !customCode) {
            let message;
 ...
 * @returns <any>object
 */
export function decryptJWT(token: string): JWTModel {
